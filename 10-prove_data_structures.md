...
```
##### Problem to Solve
return and print pre-order and post-order form the output you are looking for is above the Tree example
within the comments (Use the Startout code).

[Startout](https://github.com/RvRproduct/data_structures_guide/blob/main/tree_test_tree.py)
[Solution](https://github.com/RvRproduct/data_structures_guide/blob/main/tree_pro_tree_solu.py)